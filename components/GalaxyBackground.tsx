...
export default function GalaxyBackground(): JSX.Element {
  const GalaxyCircle = (props: JSX.IntrinsicAttributes & JSX.SVGAttributes<SVGCircleElement>) => {
    return <circle style={{
      mixBlendMode: 'screen',
  ...
  return (
    <>
      ...
      <div class="galaxy-container" style={{
        ...
        <svg class="galaxy-bg" viewBox="0 0 1000 1000" preserveAspectRatio="none" style={{
            position: 'fixed',
            top: '0',
            left: '0',
            width: '100%',
          ...
          <g filter="url(#galaxy-blur)">
            <GalaxyCircle cx="600" cy="500" r="200" fill="url(#galaxy-gradient-1)" />
            <GalaxyCircle
              cx="400"
              cy="400"
              r="300"
